...
export default function Step28Content() {
  ...
  const handleOptionClick = (index: number) => {
    ...
    setTimeout(() => {
      router.push(`/step29?name=${encodeURIComponent(name)}&balance=${encodeURIComponent(balance)}`)
    }, 1000)
  }
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 pt-6 pb-8">
        ...
        <div className="w-full max-w-md mb-4">
          ...
          <div className="relative w-full h-[6px] bg-[#1a2744] rounded-full">
            ...
            <div className="absolute left-4 top-0 h-full bg-[#F9D423] rounded-r-full" style={{ width: "86%" }} />
          </div>
        </div>

        {/* Achievement Cards - 10 cards: 5 on first row, 5 on second row */}
        <div className="w-full max-w-md mb-4 px-2">
          ...
          <div className="grid grid-cols-5 gap-1.5 mb-2">
            ...
            {/* Third card - 100x Multiplication */}
            <div className="bg-[#0d0d1a] rounded-lg border border-[#D4AF37] p-1 flex flex-col items-center">
              <div className="w-10 h-10 rounded-lg overflow-hidden mb-1 border border-[#D4AF37]">
                <Image
        ...
        <div className="w-full max-w-md bg-[#0d0d1a]/95 rounded-xl border-2 border-[#D4AF37] p-5">
          ...
          <div className="flex justify-center mb-4">
            <span className="bg-[#2a2a3e] text-gray-300 text-sm px-4 py-1.5 rounded-full">Final Choice</span>
          </div>
          ...
          {isLoading ? (
            ...
            <>
              ...
              <p className="text-white text-lg font-bold text-center mb-5 leading-relaxed">
                Do you accept to be part of a group of people who decided to create their dream life through the power
                of faith?
              </p>

              {/* Answer Options - 3 options */}
              <div className="space-y-3">
                {["Yes, I accept", "I'm not sure", "I need to think about it"].map((option, index) => (
                  <button
                    key={index}
