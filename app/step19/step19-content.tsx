...
export default function Step19Content() {
  ...
  const handleContinue = () => {
    router.push(`/step20?name=${encodeURIComponent(name)}&balance=${encodeURIComponent(balance)}`)
  }
    ...
    <div className="min-h-screen w-full flex flex-col relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center min-h-screen px-4 py-8">
        ...
        <div className="w-full max-w-sm bg-[#0d0d1a]/95 rounded-2xl border-2 border-[#D4AF37] p-6 shadow-2xl shadow-[#D4AF37]/20">
          ...
          {/* Achievement Image - Perfect Health */}
          ...
          {/* Achievement Title */}
          <h2 className="text-[#D4AF37] text-2xl font-bold text-center mb-3">Perfect Health</h2>

          {/* Achievement Description */}
          <p className="text-gray-300 text-base text-center mb-6 leading-relaxed">❤️ Your Perfect Health Is Activated</p>
