...
export default function Step23Content() {
  ...
  const handleOptionClick = (index: number) => {
    ...
    setTimeout(() => {
      router.push(`/step24?name=${encodeURIComponent(name)}&balance=${encodeURIComponent(balance)}`)
    }, 1000)
  }
  ...
  return (
    <div className="min-h-screen w-full flex flex-col relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 pt-6 pb-8">
        ...
        {/* Account Balance Section - Now shows new calculated value */}
        ...
        <div className="w-full max-w-md mb-4">
          ...
          <div className="relative w-full h-[6px] bg-[#1a2744] rounded-full">
            ...
            <div className="absolute left-4 top-0 h-full bg-[#F9D423] rounded-r-full" style={{ width: "71%" }} />
          </div>
        </div>

        {/* Achievement Cards - 8 cards: 5 on first row, 3 on second row */}
          ...
          {isLoading ? (
            ...
            <>
              ...
              <p className="text-white text-lg font-bold text-center mb-5 leading-relaxed">
                Imagine that 30 days from now, your life is 100% transformed. Which of these images represents your
                future?
              </p>
