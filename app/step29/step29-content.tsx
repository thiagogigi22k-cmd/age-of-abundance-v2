...
export default function Step29Content() {
  ...
  const handleOptionClick = (index: number) => {
    ...
    setTimeout(() => {
      router.push(`/step30?name=${encodeURIComponent(name)}&balance=${encodeURIComponent(balance)}`)
    }, 1000)
  }
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 pt-6 pb-8">
        ...
        <div className="w-full max-w-md mb-4">
          ...
          <div className="relative w-full h-[6px] bg-[#1a2744] rounded-full">
            ...
            <div className="absolute left-4 top-0 h-full bg-[#F9D423] rounded-r-full" style={{ width: "90%" }} />
          </div>
        </div>
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="space-y-3">
                {["My financial situation", "My relationships", "My health", "My purpose in life"].map(
                  (option, index) => (
                    <button
                      key={index}
